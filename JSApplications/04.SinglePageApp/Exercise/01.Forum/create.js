...
export function setUpPostButtons(postBtmTarget, cancelBtnTarget) {
    postBtn = postBtmTarget;
    cancelBtn = cancelBtnTarget;
            ...
            e('div', { className: 'topic-container' },
                e('div', { className: 'theme-content' },
                    ...
                    e('div', { className: 'comment' },
                        e('p', {}, `Date: <time>${time.toLocaleDateString()} ${time.toLocaleTimeString()}</time>`),

...
const Comment = require('../models/Comment');  // i bez tova raboti?
...
async function attachSticker(cubeId, stickerId) {
    ...
    if (!cube) {
        throw new ReferenceError('Cube! No such ID in database');
    }

    if (!sticker) {
        throw new ReferenceError('Sticker! No such ID in database');
    }
